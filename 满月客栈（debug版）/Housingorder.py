...
class Function(wx.Frame):
    def __init__(self, parent, id):
        ...
        wx.StaticText(panel, label = "*住房订单ID", pos = (185,375))
        wx.StaticText(panel, label = "房间ID", pos = (265,375))
        wx.StaticText(panel, label = "酒店ID", pos = (320,375))
        wx.StaticText(panel, label = "客户ID", pos = (375,375))
        wx.StaticText(panel, label = "日期", pos = (445,375))
        wx.StaticText(panel, label = "总消费", pos = (530,375))
