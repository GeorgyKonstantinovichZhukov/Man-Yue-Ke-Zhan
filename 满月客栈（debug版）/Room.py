...
class Function(wx.Frame):
    def __init__(self, parent, id):
        wx.Frame.__init__(self, parent, id, title = "Hotel", size =(1000, 750))
        panel = wx.Panel(self)
        ...
        wx.StaticText(panel, label = "*房间ID", pos = (200,375))
        wx.StaticText(panel, label = "*酒店ID", pos = (250,375))
        wx.StaticText(panel, label = "类型", pos = (315,375))
        wx.StaticText(panel, label = "等级", pos = (375,375))
        wx.StaticText(panel, label = "价格", pos = (425,375))
        wx.StaticText(panel, label = "状态", pos = (485,375))
