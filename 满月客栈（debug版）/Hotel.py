...
class Function(wx.Frame):
    def __init__(self, parent, id):
        wx.Frame.__init__(self, parent, id, title = "Hotel", size =(950, 750))
        panel = wx.Panel(self)
        wx.StaticText(panel, label = "*酒店ID", pos = (100,40))
        wx.StaticText(panel, label = "名字", pos = (100,90))
        wx.StaticText(panel, label = "地址", pos = (100,140))
        wx.StaticText(panel, label = "房间数量", pos = (100,190))

        wx.StaticText(panel, label = "*酒店ID", pos = (200,285))
        wx.StaticText(panel, label = "名字", pos = (270,285))
        wx.StaticText(panel, label = "地址", pos = (330,285))
        ...
        self.bt1 = wx.Button(panel, label = "查询所有信息", pos = (200,235))
        self.bt2 = wx.Button(panel, label = "查询", pos = (300,235))
        self.bt3 = wx.Button(panel, label = "录入", pos = (400,235))
        self.bt4 = wx.Button(panel, label = "删除", pos = (500,235))
        self.bt5 = wx.Button(panel, label = "修改", pos = (600,235))
        ...
        self.Text = wx.TextCtrl(panel, pos = (200,320), size = (550, 250),style =  wx.TE_MULTILINE)
