...
class SearchRoomorder(wx.Frame):
    def __init__(self, parent, id):
        wx.Frame.__init__(self, parent, id, title = "查询房间订单", size =(700, 700))
        panel = wx.Panel(self)
        wx.StaticText(panel, label = "请输入客户ID：", pos = (50,50))
        self.Customer_ID =  wx.TextCtrl(panel, pos = (175, 50), size = (235, 25),style =  wx.TE_LEFT)

        self.bt1 = wx.Button(panel, label = "查询信息", pos = (200,100))
        self.bt2 = wx.Button(panel, label = "返回主界面", pos = (300,100))
        ...
        self.Text = wx.TextCtrl(panel, pos = (50,200), size = (600, 400),style =  wx.TE_MULTILINE)
