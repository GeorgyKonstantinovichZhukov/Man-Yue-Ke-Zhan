...
class Function(wx.Frame):
    def __init__(self, parent, id):
        ...
        self.bt1 = wx.Button(panel, label = "Hotel", pos = (100, 40))
        self.bt2 = wx.Button(panel, label = "Order", pos = (100, 80))
        self.bt3 = wx.Button(panel, label = "Room", pos = (100, 120))
        self.bt4 = wx.Button(panel, label = "Exit", pos = (100, 160))
