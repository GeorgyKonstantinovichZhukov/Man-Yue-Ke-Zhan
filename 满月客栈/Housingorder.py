...
class Function(wx.Frame):
    def __init__(self, parent, id):
        wx.Frame.__init__(self, parent, id, title = "Order", size =(1000, 750))
        panel = wx.Panel(self)
        ...
        wx.StaticText(panel, label = "*住房订单ID", pos = (200,375))
        wx.StaticText(panel, label = "房间ID", pos = (315,375))
        wx.StaticText(panel, label = "酒店ID", pos = (370,375))
        wx.StaticText(panel, label = "客户ID", pos = (430,375))
        wx.StaticText(panel, label = "日期", pos = (500,375))
        wx.StaticText(panel, label = "总消费", pos = (590,375))
        ...
        self.bt1 = wx.Button(panel, label = "查询所有信息", pos = (200,325))
        self.bt2 = wx.Button(panel, label = "查询", pos = (300,325))
        self.bt3 = wx.Button(panel, label = "录入", pos = (400,325))
        self.bt4 = wx.Button(panel, label = "删除", pos = (500,325))
        self.bt5 = wx.Button(panel, label = "修改", pos = (600,325))
        ...
        self.Text = wx.TextCtrl(panel, pos = (200,400), size = (550, 250),style =  wx.TE_MULTILINE)
